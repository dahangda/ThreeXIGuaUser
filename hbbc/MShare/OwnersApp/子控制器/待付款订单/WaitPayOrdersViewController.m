...
@interface WaitPayOrdersViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WaitPayOrdersViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *goodsSNID = [_aorderArr[indexPath.row] objectForKey:@"GoodsSNID"];
    ...
    cell.theOrderBlock = ^{
        ...
        [[NetworkSingleton shareManager] httpRequest:parameters url:CHECKOUT success:^(id responseBody){
            DHResponseBodyLog(responseBody);
            if ([responseBody[@"Notice"] isEqualToString:@"操作成功"]) {
                [weakself ajson];
            }
