...
@interface TheBillViewController ()<SGTopTitleViewDelegate,UIScrollViewDelegate>
...
@implementation TheBillViewController
...
- (void)viewDidLoad {
    ...
    OrderBillViewController *homeVC= [[OrderBillViewController alloc]init];
...
- (void)setupChildViewController {
    ...
    //账户充值
    RechargeBillViewController *rbvc = [[RechargeBillViewController alloc] init];
    [self addChildViewController:rbvc];
}
