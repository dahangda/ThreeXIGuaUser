...
@interface OrderBillViewController ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)ajson
{
    ...
    [[NetworkSingleton shareManager] httpRequest:parameters url:LookOrderPayBill success:^(id responseBody){
